...
const Navbar = () => {
  ...
  return (
    <header className="sticky top-0 z-50 w-full backdrop-blur-md bg-slate-50/80 dark:bg-slate-900/80 border-b border-slate-200 dark:border-slate-800 transition-colors duration-300">
